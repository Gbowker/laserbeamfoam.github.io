...
<div id="where-to-start">
    <div class="where-to-start-item" id="solvers">
     <img src="images/solvers.png" class="top-right-img">
    <p>
    ...
    <div class="where-to-start-item" id="utilities">
    <img src="images/utilities.png" class="top-right-img">
    <p>
     The <b>Utilities</b> page provides a list of available utilities, their use and installation instructions, along with additional tools for the workflow.
       ...
       <div class="where-to-start-item" id="publications"> 
    <img src="images/publications2.png" class="top-right-img">
    <p>
    ...
    <div class="where-to-start-item" id="contact"> 
    <img src="images/contact.png" class="top-right-img">
    <p>
